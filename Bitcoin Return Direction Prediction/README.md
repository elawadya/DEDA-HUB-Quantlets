...
Code_Files: Bitcoin_return_direction_prediction.ipynb

Data_Files: btc_raw.csv, feargreed_raw.csv, bitcoin_sentiments_21_24.csv, vader_daily.csv

Output_Files: model_results.csv, model_accuracy.png, roc_curves.png, shap_beeswarm.png, shap_bar.png, bootstrap_ci.png, mcnemar_heatmap_tech.png, mcnemar_heatmap_fg.png, confusion_matrix_best.png, feature_importance_main.png, feature_importance_overlap.png, market_regime.png, trading_strategy.png, best_params.json, best_params_ol.json, lstm_best_params.json

Libraries: numpy, pandas, yfinance, matplotlib, sklearn, scipy, tensorflow, keras, optuna, xgboost, lightgbm, shap
